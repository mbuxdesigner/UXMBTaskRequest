...
export const UX_PHASE_COLOR_PALETTE: StatusBadgeConfig[] = [
  ...
  // Khâu 3: Wireframe / User Flow
  {
    variant: "info",
    dotColor: "bg-blue-500",
    inlineClasses: { bg: "bg-blue-50", text: "text-blue-700", border: "border-blue-200", dot: "bg-blue-500" },
  },
  // Khâu 4: UI Design
  {
    variant: "success",
    dotColor: "bg-emerald-500",
    inlineClasses: { bg: "bg-emerald-50", text: "text-emerald-700", border: "border-emerald-200", dot: "bg-emerald-500" },
  },
